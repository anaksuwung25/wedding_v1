            ...
            <div class="column">
                    ...
                    <div id="tab-gallery" class="tab-content__item">
                        <div class="tz-gallery">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery13}}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery13 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery14 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery14 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery15 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery15 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery16 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery16 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery17 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery17 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery18 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery18 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery19 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery19 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery20 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery20 }}">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/storage/') }}/{{ $item->gallery21 }}">
                                        <img src="{{ url('/storage/') }}/{{ $item->gallery21 }}">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <footer>
                    <div class="ss-copyright">
                        ...
                        @endforeach
                        <span>Developed by <a target="_blank">anaksuwung</a></span>
                    </div>
                </footer>
